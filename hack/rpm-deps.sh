...
LIBVIRT_VERSION=${LIBVIRT_VERSION:-0:9.5.0-7.el9}
QEMU_VERSION=${QEMU_VERSION:-17:8.0.0-16.el9}
SEABIOS_VERSION=${SEABIOS_VERSION:-0:1.16.1-1.el9}
EDK2_VERSION=${EDK2_VERSION:-0:20230524-4.el9}
...
BASESYSTEM=${BASESYSTEM:-"rocky-release"}
